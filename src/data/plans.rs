...
use crate::model::plan::{MarkdownLine, MarkdownLineKind, PlanFile};
...
/// Pull the first `# ` heading from content, falling back to "(untitled)".
...
/// Classify each line of markdown content.
